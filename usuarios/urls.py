...
urlpatterns = [
    ...
    path('personal/<int:user_id>/verificar/', views.verificar_personal_email, name='verificar_personal_email'),
    path('personal/<int:user_id>/reenviar-codigo/', views.reenviar_codigo_personal, name='reenviar_codigo_personal'),
